...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_orders,read_customers,read_payment_customizations,write_payment_customizations,read_payment_gateways,write_payment_sessions,write_payment_gateways,read_payment_sessions'),
    ...
    */
    ...
    'webhooks' => [
            ...
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://shopify-vm6.one-pix.dev/webhook/app-uninstalled')
            ],
    ...
    */
    ...
    'provider_id' => env('SHOPIFY_PAYMENT_PROVIDER_ID', '86736897'),
];
